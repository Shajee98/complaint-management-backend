...
const DescResponse: RequestHandler = async (req, res, next) => {
  try {
    ...
    const { customer_number, customer_name,complaint_number, description, staff_id, department_id, complaint_status_id, complaint_type_id, fromWhatsapp, created_by } = req.body
    ...
    const whatsapp_complaint = await complaintService.createComplaint({customer_number, customer_name,complaint_number, description, staff_id, department_id, complaint_status_id, complaint_type_id, fromWhatsapp, created_by})
